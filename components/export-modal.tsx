        ...
        <div className="fixed inset-0 z-[1000] flex flex-col items-center justify-center p-6 sm:p-10">
          ...
          <div className="absolute opacity-0 pointer-events-none overflow-hidden" style={{ width: 1080, height: 1920 }}>
            ...
            >
              ...
              <div 
                className={cn(
                  "italic leading-[1.6] tracking-[0.03em] whitespace-pre-wrap break-words w-full",
          ...
          >
            ...
            <button
              ...
              className={cn(
                "group flex items-center justify-center gap-3 px-10 py-5 font-italiana text-lg tracking-[0.1em] rounded-full transition-all shadow-xl w-full max-w-[320px]",
                isSaved ? "bg-green-500/20 text-green-400 border border-green-500/30" : "bg-[#f2ece0] text-black hover:scale-105 active:scale-95"
              )}
            >
